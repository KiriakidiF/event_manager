defmodule EventManagerWeb.EventControllerTest do
  ...
  @create_attrs %{date: "2010-04-17T14:00:00Z", desc: "some desc", invitees: [], name: "some name"}
  @update_attrs %{date: "2011-05-18T15:01:01Z", desc: "some updated desc", invitees: [], name: "some updated name"}
  @invalid_attrs %{date: nil, desc: nil, invitees: nil, name: nil}
